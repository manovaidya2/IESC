    ...
    >
      ...
      <div className="relative z-10  mx-auto px-6 lg:px-10 pt-[42px] pb-[42px]">
        <div className="max-w-[580px]">
          ...
          <p className="max-w-[560px] text-[17px]  font-semibold leading-[1.7] text-[#e2e8eb] mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            <button className="h-[46px] px-7 bg-[#ed1c1c] border-2 border-[#ed1c1c] font-bold text-white text-[13px] font-black rounded-[3px] flex items-center gap-5">
              Explore All Programs
              <ArrowRight size={17} />
            </button>

            <button className="h-[46px] px-7 bg-black/20 border-2 font-bold border-white/40 text-white text-[13px] font-black rounded-[3px] flex items-center gap-5">
