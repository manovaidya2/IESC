    ...
    >
      ...
      <div className="relative z-10  mx-auto px-6 lg:px-10 pt-[45px] pb-[42px]">
        <div className="max-w-[650px]">
          ...
          <p className="max-w-[610px] text-[18px] font-semibold leading-[1.65] text-[#e2e8eb] mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            <button className="h-[46px] px-7 bg-[#ed1c1c] border-2 border-[#ed1c1c] text-white text-[14px] font-semibold font-black rounded-[3px] flex items-center gap-5">
              Explore Assessments
              <ArrowRight size={17} />
            </button>

            <button className="h-[46px] px-7 bg-black/20 border-2 border-white/40 text-white text-[14px] font-semibold font-black rounded-[3px] flex items-center gap-5">
              Assessment Process
              <ArrowRight size={17} />
            </button>
          </div>
